...
dependencies {
    ...
    implementation(project(":appdimens_dynamic"))

    // Optional: For traditional SDP/SSP scaling
    implementation(project(":appdimens_sdps"))
    implementation(project(":appdimens_ssps"))

    // Optional: To include all functionalities
    implementation(project(":appdimens_all"))
}
```
