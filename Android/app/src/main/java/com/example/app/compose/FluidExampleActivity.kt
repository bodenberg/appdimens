...
fun BasicFluidExample() {
    // Font size that scales smoothly from 16 to 24 between 320-768dp
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "Font size smoothly scales between 16sp (320dp screen) and 24sp (768dp screen)",
...
fun MultipleFluidValuesExample() {
    ...
    Card(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = "Font, padding, and margin all use fluid scaling",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
        }
...
fun FluidBuilderInfoExample() {
    ...
    Card(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = "Min: ${fluidBuilder.getMin()}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
            Text(
                text = "Max: ${fluidBuilder.getMax()}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
            Text(
                text = "Preferred: ${fluidBuilder.getPreferred()}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
            Text(
                text = "At 25%: ${fluidBuilder.lerp(0.25f)}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
            Text(
                text = "At 50%: ${fluidBuilder.lerp(0.5f)}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
            Text(
                text = "At 75%: ${fluidBuilder.lerp(0.75f)}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
        }
...
fun ExtensionMethodsExample() {
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "Min: ${fluid.getMin()}, Max: ${fluid.getMax()}",
                style = MaterialTheme.typography.bodySmall,
                color = Color.Gray
            )
        }
