...
class AppDimensDynamic {
  ...
  AppDimensDynamic screen(UiModeType uiModeType, double customValue) {
  ...
  /// @param customValue O valor de dimensão customizado.
  /// @return A instância AppDimensDynamic para encadeamento.
  AppDimensDynamic screenWithIntersection(
  ...
  /// [EN] Returns the dynamically adjusted value in density-independent pixels (dp).
  /// @param context The BuildContext.
  /// @return The value in dp as a double.
  /// [PT] Retorna o valor ajustado dinamicamente em pixels independentes de densidade (dp).
  /// @param context O BuildContext.
  ...
  /// [EN] Returns the dynamically adjusted value in density-independent pixels (dp) as an integer.
  /// @param context The BuildContext.
  /// @return The value in dp as an int.
  /// [PT] Retorna o valor ajustado dinamicamente em pixels independentes de densidade (dp) como inteiro.
  /// @param context O BuildContext.
  ...
  /// [EN] Returns the dynamically adjusted value in physical pixels (px).
  /// @param context The BuildContext.
  /// @return The value in pixels as a double.
  /// [PT] Retorna o valor ajustado dinamicamente em pixels físicos (px).
  /// @param context O BuildContext.
  ...
  /// [EN] Returns the dynamically adjusted value in physical pixels (px) as an integer.
  /// @param context The BuildContext.
  /// @return The value in pixels as an int.
  /// [PT] Retorna o valor ajustado dinamicamente em pixels físicos (px) como inteiro.
  /// @param context O BuildContext.
  ...
  /// [EN] Returns the dynamically adjusted value in scalable pixels (sp) as an integer.
  /// @param context The BuildContext.
  /// @return The value in sp as an int.
  /// [PT] Retorna o valor ajustado dinamicamente em pixels escaláveis (sp) como inteiro.
  /// @param context O BuildContext.
  ...
  /// [EN] Returns the dynamically adjusted value in em units as an integer.
  /// @param context The BuildContext.
  /// @return The value in em as an int.
  /// [PT] Retorna o valor ajustado dinamicamente em unidades em como inteiro.
  /// @param context O BuildContext.
