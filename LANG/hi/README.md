...
- **📐 गणितीय सटीकता**: विभिन्न डिज़ाइन आवश्यकताओं के लिए दो स्केलिंग मॉडल (Fixed और Dynamic)
...
| मॉडल | दर्शन | आदर्श उपयोग केस | समर्थित प्लेटफॉर्म |
|-------|------------|----------------|-------------------|
| **Fixed (FX)** | लॉगरिदमिक स्केलिंग (परिष्कृत) | बटन, पैडिंग, मार्जिन, आइकन | Android + iOS |
| **Dynamic (DY)** | आनुपातिक स्केलिंग (आक्रामक) | कंटेनर, ग्रिड, फ्लूइड फॉन्ट | Android + iOS |
| **SDP / SSP** | पूर्व-गणना किए गए संसाधन | XML में सीधे `@dimen` उपयोग | Android |
| **भौतिक इकाइयाँ** | mm/cm/inch → Dp/Sp/Px/Points | वियरेबल्स, प्रिंटिंग, सटीक लेआउट | Android + iOS |
