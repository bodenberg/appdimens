...
Welcome to the complete AppDimens documentation. This page serves as a central index to all documentation resources.
...
| [Examples](EXAMPLES.md) | Real-world code samples | 20 min |
...
|----------|-------------|
| [Mathematical Theory](MATHEMATICAL_THEORY.md) | Formal mathematical foundation |
| [Simplified Theory](MATHEMATICAL_THEORY_SIMPLIFIED.md) | Easy-to-understand version |
| [Formula Comparison](FORMULA_COMPARISON.md) | Comparison with 7 other solutions |
...
| Resource | Description |
|----------|-------------|
| [Comprehensive Guide](COMPREHENSIVE_TECHNICAL_GUIDE.md) | Complete technical documentation |
| [Examples](EXAMPLES.md) | Code examples for all platforms |
...
4. [Comprehensive Guide](COMPREHENSIVE_TECHNICAL_GUIDE.md) - Master everything (2 hours)
...
4. [Comprehensive Guide](COMPREHENSIVE_TECHNICAL_GUIDE.md) - Complete reference (2 hours)
...
### Scaling Models
- [Fixed (FX) Model](MATHEMATICAL_THEORY_SIMPLIFIED.md#fixed-fx-model)
- [Dynamic (DY) Model](MATHEMATICAL_THEORY_SIMPLIFIED.md#dynamic-dy-model)
- [SDP/SSP Models](MATHEMATICAL_THEORY_SIMPLIFIED.md#sdpssp-models)

### Implementation
- [Android Examples](EXAMPLES.md#android)
- [iOS Examples](EXAMPLES.md#ios)
- [Flutter Examples](EXAMPLES.md#flutter)
- [React Native Examples](EXAMPLES.md#react-native)
- [Web Examples](EXAMPLES.md#web)

### Theory
- [Weber-Fechner Law](MATHEMATICAL_THEORY.md#weber-fechner-law)
- [Logarithmic Scaling](MATHEMATICAL_THEORY.md#logarithmic-scaling)
- [Aspect Ratio Compensation](MATHEMATICAL_THEORY.md#aspect-ratio-compensation)

### Performance
- [Benchmarks](../Android/BENCHMARK.md)
- [Performance Optimization](COMPREHENSIVE_TECHNICAL_GUIDE.md#performance)
...
- 📉 **65% less oversizing** on tablets
- 🔬 **Only library** with logarithmic scaling
- 🎨 **Only library** with aspect ratio compensation
...
- 🐛 [Report Issues](https://github.com/bodenberg/appdimens/issues)
- 💬 [Join Discussions](https://github.com/bodenberg/appdimens/discussions)
...
3. **Ask Questions** - Use [GitHub Discussions](https://github.com/bodenberg/appdimens/discussions)
4. **Report Bugs** - Create an [Issue](https://github.com/bodenberg/appdimens/issues)
